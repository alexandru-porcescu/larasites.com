...
class Color
{
    ...
    {
        // Convert RGB to HEX, explicit string conversions
        $hex[0] = (string) dechex($rgb[0]);
        $hex[1] = (string) dechex($rgb[1]);
        $hex[2] = (string) dechex($rgb[2]);

        // Make sure that 2 digits are allocated to each color {Sam added on 2015-02-14}
